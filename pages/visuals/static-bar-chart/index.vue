...
<template>
  <article>
    ...
    <section>
      <p class="lead">
        This is an example of a reactive static bar chart. The chart is
        responsive to changes in data, outer padding, inner padding, and SVG
        size.
      </p>
    </section>
    ...
    <section class="row">
      <div class="col-3">
        <label class="form-label" for="input-outer-padding"
          >Outer padding</label
        >
        <input
      ...
      <div class="col-3">
        <label class="form-label" for="input-inner-padding"
          >Inner padding</label
        >
        <input
